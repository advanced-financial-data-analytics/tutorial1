...
We will be working with financial market data from the `fin7028_dat.RData` file, which contains:
- Daily stock prices and returns for several companies
- Market benchmark data (FTSE 350)
- Risk-free rate data
